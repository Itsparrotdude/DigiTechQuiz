"""This module is for randomly swapping answers."""
import random
...
while True:
    ...
    if yearlvl.isdigit():
        if yearlvl == "11":
            ...
            print("Here is a list of all the Year 11 subjects:")
            ...
            while True:
                ...
                if studysubject == "Math" or studysubject == "1":
                    ...
                    while True:
                        ...
                        if mathquizuserchoice == "1":
                            print("You have chosen chosen Math Quiz #1, let's begin!")
                            ...
                            print(f"Nice one {name}! Your final score is: {score}/{len(mathquiz1y11)}")
